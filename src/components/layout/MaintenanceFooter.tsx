...
function isAuthorizedIP() {
  // Lista de IPs autorizadas (esto se podría mover a variables de entorno)
  const authorizedIPs = ['127.0.0.1', 'localhost'];
  // En un caso real, obtendrías la IP del cliente desde el servidor
  return false; // Por defecto false para usuarios públicos
}
...
export default function MaintenanceFooter() {
  ...
  if (showFullFooter) {
    // Footer completo para usuarios autorizados/preview
    return (
  ...
  // Footer simplificado para usuarios públicos
  return (
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
